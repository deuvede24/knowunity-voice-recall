// Exact path geometry reused from /public/images/micro.svg. Fill is
// currentColor (rather than the file's hardcoded light fill) so the same
// glyph works with dark-on-light (primary button) and light-on-dark
// contexts, per the ButtonIcon component's Primary/Secondary variants.
