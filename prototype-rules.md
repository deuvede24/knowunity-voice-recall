...
**Throughout the recall loop, keep the overall layout stable. Knowie, the concept prompt, and the recording area should remain in consistent positions while only the content changes (recording, confirmation, thinking, coaching, reminder). The experience should feel like one evolving screen rather than a sequence of disconnected pages.
