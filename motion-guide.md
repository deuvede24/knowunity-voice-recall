...
**Coaching transition.** After Helena confirms her answer, keep the layout stable. The transcript (or headline) fades away, Knowie briefly changes to the thinking expression, "Let me think..." appears, and then the coaching card slides up from the bottom. The goal is to make the experience feel like one screen whose content evolves, not multiple page changes.
